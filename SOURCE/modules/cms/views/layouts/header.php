...
<div class="navbar navbar-expand-md navbar-light navbar-static">
    <div class="navbar-brand p-2 wmin-250">
        <a class="sitename d-flex align-items-center" href="<?= Yii::$app->homeUrl ?>">
            ...
            <span class="ml-1 font-weight-bold text-white">HCMGIS PointCloud</span>
        </a>
    </div>
    <div>
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        <ul class="navbar-nav main-menu">
            <li class="nav-item">
                <a href="<?= APPConfig::getUrl('point-cloud') ?>" class="navbar-nav-link">
                    <h6 class="mb-0 font-weight-bold"><i class="icon-home mr-2"></i><?= Yii::t('app', 'Home') ?></h6>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?= APPConfig::getUrl('point-cloud/map') ?>" class="navbar-nav-link">
                    <h6 class="mb-0 font-weight-bold"><?= Yii::t('app', 'Map') ?></h6>
                </a>
            </li>
            <li class="nav-item">
