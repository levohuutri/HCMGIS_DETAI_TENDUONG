        ...
        <form class="py-3" id="pointcloud-upload-form">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <radio-button :selected="marterial" :value="'RGB'" :label="'RGB'" @choose="marterial = $event"></radio-button>
                    <radio-button :selected="marterial" :value="'ELEVATION'" :label="'ELEVATION'" @choose="marterial = $event"></radio-button>
                    <radio-button :selected="marterial" :value="'INTENSITY'" :label="'INTENSITY'" @choose="marterial = $event"></radio-button>
                    <radio-button :selected="marterial" :value="'INTENSITY_GRADIENT'" :label="'INTENSITY_GRADIENT'" @choose="marterial = $event"></radio-button>
                    <radio-button :selected="marterial" :value="'RETURN_NUMBER'" :label="'RETURN_NUMBER'" @choose="marterial = $event"></radio-button>
                    <radio-button :selected="marterial" :value="'SOURCE'" :label="'SOURCE'" @choose="marterial = $event"></radio-button>
                    <radio-button :selected="marterial" :value="'LEVEL_OF_DETAIL'" :label="'LEVEL_OF_DETAIL'" @choose="marterial = $event"></radio-button>
                    <input type="hidden" name="Params[marterial]" v-model="marterial">
                </div>
                <div class="col-md-6 form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-12 form-group text-center">
                    <button type="submit" class="btn btn-primary btn-lg btn-upload-pointcloud text-uppercase" 
                        :disabled="!title || !pointFile" @click="uploadPointCloud">
                        <i class="icon-cloud-upload icon-2x mr-2"></i>Upload point cloud
                    </button>
                </div>
            </div>
        ...
        var vm = new Vue({
            ...
            methods: {
                ...
                readFileInfo: function(e) {
                    var _this = this,
                        input = e.target,
                        api = '<?= APPConfig::getUrl('file/upload') ?>'
                ...
                readPointInfo: function(e) {
                    var _this = this,
                        input = e.target,
                        api = '<?= APPConfig::getUrl('file/upload-point') ?>'
                ...
                deleteFile: function(file) {
                    var _this = this
                    var api = '<?= APPConfig::getUrl('file/delete') ?>',
                        data = {
                            file: file
                        }
                    sendAjax(api, data, function(resp) {})
